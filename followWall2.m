...
function total_inches_traveled = followWall2(brick, gyro, clutch, usport,inches,speed)
    ...
    while abs(total_steps_moved-total_steps_to_move)>3
        ...
        % algorithm
        turnRobot(gyro, brick, clutch, angle_input);
        ...
        STEPS_PER_CHECK = 100*STEPS_PER_INCH;
    end
