classdef ClutchApp < handle
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            ClutchApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'Clutch')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong Clutch
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'Clutch').getString, ...
