classdef GyroApp < handle
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            GyroApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'Gyro')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong Gyro
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'Gyro').getString, ...
