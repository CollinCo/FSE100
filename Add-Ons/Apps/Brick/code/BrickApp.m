classdef BrickApp < handle
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            BrickApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'Brick')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong Brick
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'Brick').getString, ...
